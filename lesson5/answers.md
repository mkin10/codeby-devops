...
Your Answer: В зависимости от того сколько хостов необходимо в этой подсети, так можно взять маску /24 если например нужно по 10 хочстов, 10.10.10.0/24 и будет 5 подсетей по 10 хостов 10.10.10.0/28
